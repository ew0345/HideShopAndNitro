    ...
    start() {
        removeTabs = setInterval(() => {
            for (var i = 0; i < document.querySelectorAll('a').length; i++) {
                if (document.querySelectorAll('a')[i].href.includes('/shop') || document.querySelectorAll('a')[i].href.includes('/store') && !document.querySelectorAll('a')[i].href.includes("steampowered")) {
